...
BOOST_AUTO_TEST_CASE(file_downloader)
{
	...
	const auto destination{
		std::filesystem::temp_directory_path() / "network_layout.json"
	};
	...
	// We can not check the entire content as it changes over time
	// but we can atleast check some expected file properties
	{
